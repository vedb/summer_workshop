...
Usage: python detect_pupil.py [data_path] [start_time] [end_time]
...
def detect_pupil(data_path, start_index, end_index):
...
if __name__ == "__main__":
    ...
    print("args:", sys.argv)
    detect_pupil(data_path, start_index, end_index)
